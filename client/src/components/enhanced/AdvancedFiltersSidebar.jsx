...
const AdvancedFiltersSidebar = ({
  ...
  React.useEffect(() => {
    if (showFilters && initialSection) {
      setActiveSection(initialSection);
    }
  }, [showFilters, initialSection]);
  ...
  return (
    <motion.div 
      className="w-96 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 h-full overflow-y-auto backdrop-blur-xl"
    ...
    >
      ...
      <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-[#51faaa]/10 to-[#dbd5a4]/10">
        ...
        {/* Section Navigation - Improved Layout */}
                  ...
                  <div className="space-y-2">
                    {priceRanges.map((range, index) => (
                      <motion.button
                        ...
                        transition={{ duration: 0.2 }}
                      >
                        <span className="text-gray-800 dark:text-gray-200">{range.label}</span>
                      </motion.button>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {amenities.map((amenity) => (
                      ...
                      >
                        {amenity.icon}
                        <span className="text-sm font-medium text-gray-800 dark:text-gray-200">{amenity.label}</span>
                      </motion.button>
                    ))}
                  </div>
                </div>
        ...
        <div className="space-y-3">
          <div className="text-center">
            <p className="text-xs text-gray-600 dark:text-gray-300 mb-2">
              Applied Filters: {Object.values(filters).filter(v => v && (Array.isArray(v) ? v.length > 0 : true)).length}
            </p>
          </div>
          <motion.button
