  ...
  const testimonials = [
    {
      ...
      content: "Rental Management transformed my rental business. I went from spending 20 hours a month chasing payments to just 3 hours. My collection rate is now 98%.",
      rating: 5
    },
    {
      name: "James Mwangi",
      ...
      <section className="py-20 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              See how Rental Management is transforming rental businesses across Kenya
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Rental Management. All rights reserved.
            </p>
