  ...
  return (
    <div className="fixed top-6 right-6 z-50" ref={dropdownRef}>
      ...
      <motion.button
        ...
        className={`group relative flex items-center gap-3 px-3 py-2 rounded-full shadow-elevation-4 border transition-all duration-300 overflow-hidden ${isDark
            ...
            <div className="p-4 space-y-1">
              {visibleItems.map((item, index) => (
                <motion.button
                  ...
                  className={`w-full flex items-center gap-4 px-4 py-3 rounded-2xl text-left group relative overflow-hidden ${item.highlight
                      ? isDark
              ...
              {/* Elegant Separator */}
              <div className={`my-4 h-px bg-gradient-to-r ${isDark
              ...
              <motion.button
                ...
                className={`w-full flex items-center gap-4 px-4 py-3 rounded-2xl text-left group relative overflow-hidden ${isDark
              ...
              >
                ...
                <motion.div
                  className={`p-2 rounded-xl relative z-10 ${isDark ? 'bg-red-900/30 group-hover:bg-red-800/40' : 'bg-red-100 group-hover:bg-red-200'
                    }`}
                  whileHover={{
                    rotate: -5,
                    scale: 1.1
