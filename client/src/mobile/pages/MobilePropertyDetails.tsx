      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center p-6">
          ...
          <button
            ...
            className="px-6 py-2 bg-[#3b82f6] text-[#111] rounded-lg font-medium hover:bg-[#45e695] transition-colors"
          >
            Browse Properties
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="p-4 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            {(property.bedrooms || property.bedroom) && (
              <div className="text-center">
                <div className="w-12 h-12 bg-[#3b82f6]/20 rounded-lg flex items-center justify-center mx-auto mb-2">
                  <Bed className="w-6 h-6 text-[#3b82f6]" />
                </div>
                ...
                {amenities.map((amenity, index) => (
                  <div key={index} className="flex items-center gap-3 p-3 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                    <div className="w-8 h-8 bg-[#3b82f6]/20 rounded-lg flex items-center justify-center">
                      {amenitiesIcons[amenity.toLowerCase()] || <Home className="w-4 h-4 text-[#3b82f6]" />}
                    </div>
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                <button
                  onClick={handleCall}
                  className="w-full flex items-center gap-3 p-4 bg-[#3b82f6] text-[#111] rounded-lg font-medium hover:bg-[#45e695] transition-colors"
                >
      ...
      <button
        ...
        className="fixed bottom-20 right-4 w-14 h-14 bg-[#3b82f6] text-[#111] rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center hover:scale-110"
      >
