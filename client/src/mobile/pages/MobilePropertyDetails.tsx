...
import { formatKes } from "../../services/aiInsights";
  ...
  const getPropertyLocation = () => {
    if (property?.location) {
      ...
      if (typeof property.location === 'object' && property.location !== null) {
        const loc = property.location as PropertyLocation;
        if (loc.city) {
          return loc.city;
        }
        if (loc.address) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          <Loader2 className="w-12 h-12 text-[#505050] animate-spin mx-auto mb-4" />
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="pb-20">
        <div className="p-4 space-y-6">
          ...
          <div>
            ...
            <div className="text-2xl font-bold text-[#505050] mb-3">
          ...
          <div className="grid grid-cols-3 gap-4">
            {(property.bedrooms || property.bedroom) && (
              <div className="text-center">
                <div className="w-12 h-12 bg-[#505050]/20 rounded-lg flex items-center justify-center mx-auto mb-2">
                  <Bed className="w-6 h-6 text-[#505050]" />
                </div>
            ...
            {(property.bathrooms || property.bathroom) && (
              <div className="text-center">
                <div className="w-12 h-12 bg-[#505050]/20 rounded-lg flex items-center justify-center mx-auto mb-2">
                  <TrendingUp className="w-6 h-6 text-[#505050]" />
                </div>
                <div className="text-lg font-semibold text-gray-900 dark:text-white">
                  {(property.bathrooms || property.bathroom) as string | number}
                </div>
            ...
            {property.type && (
              <div className="text-center">
                <div className="w-12 h-12 bg-[#505050]/20 rounded-lg flex items-center justify-center mx-auto mb-2">
                  <Building className="w-6 h-6 text-[#505050]" />
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {amenities.map((amenity, index) => (
                  <div key={index} className="flex items-center gap-3 p-3 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                    <div className="w-8 h-8 bg-[#505050]/20 rounded-lg flex items-center justify-center">
                      {amenitiesIcons[amenity.toLowerCase()] || <Home className="w-4 h-4 text-[#505050]" />}
                    </div>
      ...
      <button
        ...
        className="fixed bottom-20 right-4 w-14 h-14 bg-[#505050] text-[#111] rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center hover:scale-110"
      >
