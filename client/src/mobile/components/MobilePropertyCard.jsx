...
const MobilePropertyCard = ({ property, onFavoriteToggle, isFavorite }) => {
  ...
  return (
    <div className={`group bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden transition-all duration-300 cursor-pointer hover:shadow-xl lg:hidden ${isDark ? 'border border-gray-700' : 'border border-gray-200'
      }`}>
      {/* Image Section */}
          ...
          <div className="flex items-center text-gray-600 dark:text-gray-400 text-sm">
            ...
            <span className="line-clamp-1">
              {typeof property.address === 'object'
                ? (property.address.address || property.address.city || 'Location available')
