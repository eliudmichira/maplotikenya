...
export const PropertyMobileLayout = ({
  ...
  const leftAction = showBackButton ? (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
    >
      <ArrowLeft className={`w-5 h-5 ${iconClass}`} />
    </motion.button>
  ) : showMenuButton ? (
    <motion.button
      onClick={() => {
  ...
  return (
    <div className={`flex flex-col h-screen bg-gradient-to-br from-gray-300  to-gray-300 dark:from-black dark:via-gray-900 dark:to-black ${className}`}>
      ...
      {/* Fixed Bottom Navigation - Standard Pill Style */}
