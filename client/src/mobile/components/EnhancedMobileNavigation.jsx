...
const EnhancedMobileNavigation = () => {
  ...
  return (
    <>
      ...
      <motion.div
        className={`fixed bottom-6 left-4 right-4 z-50 lg:hidden rounded-full shadow-2xl ${isDark ? 'bg-gray-900/95 backdrop-blur-xl border border-gray-700/50 shadow-black/40' : 'bg-white/95 backdrop-blur-xl border border-gray-200/50 shadow-black/10'
          }`}
        initial={{ y: 100 }}
        animate={{ y: 0 }}
        ...
        {isSearchOpen && (
          ...
          >
            ...
            >
              ...
              <div className={`flex items-center justify-between p-4 border-b ${isDark ? 'bg-gray-900/95 backdrop-blur-xl border-gray-700/50' : 'bg-white/95 backdrop-blur-xl border-gray-200/50'
                }`}>
                <motion.button
                  onClick={() => setIsSearchOpen(false)}
                  className={`p-2 rounded-lg ${isDark ? 'text-white hover:bg-gray-800/50' : 'text-gray-600 hover:bg-gray-100/50'
                    }`}
              ...
              <div className="flex-1 p-4 space-y-4 overflow-y-auto">
                {currentUser ? (
                  <>
                    {/* Enhanced User Info */}
                    <motion.div
                      className={`p-4 rounded-xl ${isDark ? 'bg-gray-800/50 backdrop-blur-sm' : 'bg-gray-100/50 backdrop-blur-sm'
                        }`}
                  ...
                  >
                    ...
                    <Link
                      to="/auth"
                      className={`w-full py-3 border-2 rounded-xl font-semibold text-center transition-colors ${isDark
