...
const AccountDashboard = () => {
      ...
      <div className={`${isDark ? 'bg-[#0e1311] border-[rgba(251,191,36,0.2)]' : 'bg-white border-gray-200 shadow-lg'} rounded-2xl p-8 border`}>
        <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-8">
          ...
          <div className="relative">
            <div className="w-24 h-24 bg-gradient-to-br from-[#fbbf24] to-[#f59e0b] rounded-full flex items-center justify-center overflow-hidden">
              {user.avatar ? (
                <img
                  src={user.avatar}
                  alt={user.name}
  ...
  const renderSettingsTab = () => (
    <div className="space-y-8">
        ...
        <div className={`${isDark ? 'bg-[#0e1311] border-[rgba(251,191,36,0.2)]' : 'bg-white border-gray-200 shadow-lg'} rounded-2xl p-6 border`}>
          ...
          <div className="space-y-4">
            <button className={`w-full text-left flex items-center justify-between p-4 rounded-xl transition-colors border ${
              isDark 
                ? 'bg-[#000000] border-[rgba(251,191,36,0.1)] hover:bg-[rgba(251,191,36,0.1)]' 
      ...
      {/* Danger Zone */}
      <div className={`${isDark ? 'bg-[#0e1311]' : 'bg-white'} rounded-2xl p-6 border border-red-500/20 shadow-lg`}>
            ...
            <div key={inquiry.id} className={`${isDark ? 'bg-[#0e1311] border-[rgba(251,191,36,0.2)]' : 'bg-white border-gray-200'} rounded-xl p-6 border`}>
              <div className="flex justify-between items-start mb-4">
                ...
                <span className={`text-xs px-2 py-1 rounded-full ${
                  inquiry.status === 'new' ? 'bg-emerald-100 text-emerald-800' :
  ...
  const renderAnalyticsTab = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className={`${isDark ? 'bg-[#0e1311] border-[rgba(251,191,36,0.2)]' : 'bg-white border-gray-200'} rounded-xl p-6 border`}>
