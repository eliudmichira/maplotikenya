        ...
        <section id="overview" className={`${activeSection === 'overview' ? 'block' : 'hidden'}`}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-20">
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-emerald-600 to-purple-600 rounded-3xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-500"></div>
              <div className="relative bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-white/20 dark:border-gray-700/20">
                <div className="w-16 h-16 bg-gradient-to-r from-emerald-500 to-purple-600 rounded-2xl flex items-center justify-center mb-6">
            ...
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-emerald-600 to-secondary-400 rounded-3xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-500"></div>
              <div className="relative bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-white/20 dark:border-gray-700/20">
                <div className="w-16 h-16 bg-gradient-to-r from-emerald-500 to-secondary-400 rounded-2xl flex items-center justify-center mb-6">
          ...
          {/* Company Values */}
          <div className="bg-gradient-to-r from-slate-50 to-emerald-50 dark:from-gray-800 dark:to-gray-700 rounded-3xl p-12">
            ...
            <div className="space-y-8">
                  ...
                  {[
                    ...
                    <div key={index} className="flex items-center justify-between p-4 bg-slate-50 dark:bg-gray-700 rounded-xl group hover:bg-slate-100 dark:hover:bg-gray-600 transition-colors">
                      ...
                      <div className="text-right">
                        <p className="font-bold text-emerald-600 dark:text-emerald-400">{area.properties}</p>
              ...
              <div className="bg-gradient-to-r from-emerald-50 to-[#faf7e6] dark:from-emerald-900/20 dark:to-[#4a4528]/30 rounded-3xl p-8 border border-emerald-200 dark:border-emerald-700/30">
                ...
                <div className="grid grid-cols-2 gap-4 text-center">
                  ...
                  <div>
                    <div className="text-2xl font-bold text-secondary-400 dark:text-secondary-200">290+</div>
