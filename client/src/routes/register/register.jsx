  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative group">
        <div className={`relative flex items-center border-2 rounded-full px-6 py-4 transition-all duration-700 ease-out backdrop-blur-xl ${isDark
          ...
          {type === 'password' && (
            <button
              ...
              disabled={disabled}
              className={`p-2 rounded-full transition-all duration-700 ease-out ${isDark
        ...
        <div className={`absolute inset-0 pointer-events-none rounded-full transition-all duration-700 ease-out ${isFocused
          ? isDark
          ...
          <div className="space-y-6">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-start gap-3">
                <input
                  type="checkbox"
                  className={`w-5 h-5 mt-1 border-2 rounded focus:ring-2 transition-all duration-200 ${isDark
                ...
                <div className="flex-1">
                  <span className={`text-sm font-medium tracking-wide transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'
                    }`}>
                    I agree to the{' '}
                    <button
                      type="button"
                      onClick={() => navigate('/terms')}
                      className={`underline hover:no-underline transition-all duration-300 ${isDark ? 'text-emerald-400 hover:text-emerald-300' : 'text-emerald-600 hover:text-emerald-700'
                        }`}
                    >
                      Terms of Service
                    </button>
            ...
            <div className={`text-center pt-6 border-t transition-all duration-700 ease-out ${isDark ? 'border-gray-700/50' : 'border-gray-200/50'
              ...
              <button
                onClick={() => navigate('/login')}
                className={`text-base font-semibold tracking-wide transition-colors disabled:opacity-50 ${isDark ? 'text-gray-300 hover:text-emerald-400' : 'text-gray-700 hover:text-emerald-600'
                  }`}
