...
// Using the original Unsplash image that was on the homepage
const heroImageUrl = 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&h=1080&q=80';
...
const PropertyOwnerPortal = () => {
  ...
  const accessPlans = [
    ...
    },
    {
      ...
      icon: Briefcase,
      gradient: "from-emerald-600 via-secondary-400 to-teal-500",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <motion.p
              ...
              className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto mb-8 drop-shadow-md"
            >
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="flex items-center mb-6">
                  <div className="w-12 h-12 bg-gradient-to-br from-emerald-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold mr-4">
                    {testimonial.avatar}
                  </div>
                  <div>
      ...
      {/* Final CTA Section */}
      <section className="py-20 bg-gradient-to-r from-emerald-600 via-purple-600 to-pink-600">
