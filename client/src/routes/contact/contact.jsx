      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          <button
            ...
            className={`flex items-center gap-3 mb-6 transition-colors group font-outfit ${
              isDark ? 'text-[#ccc] hover:text-[#000000]' : 'text-gray-600 hover:text-[#000000]'
            }`}
          >
        ...
        <div className="grid xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-2">
            <div className={`${isDark ? 'bg-[#0e1311] border-[rgba(251,191,36,0.2)]' : 'bg-white border-gray-200 shadow-lg'} rounded-2xl p-8 border transition-colors duration-300`}>
              <div className="mb-8">
                <h2 className={`text-2xl font-outfit font-bold mb-3 ${isDark ? 'text-[#feffff]' : 'text-gray-900'}`}>Send Us a Message</h2>
                <div className="w-20 h-1 bg-gradient-to-r from-[#fbbf24] to-[#f59e0b] rounded-full"></div>
              </div>
              
              {contactData?.propertyTitle && (
                <div className={`${isDark ? 'bg-[rgba(251,191,36,0.1)] border-[rgba(251,191,36,0.2)]' : 'bg-emerald-50 border-emerald-200'} border-l-4 border-[#fbbf24] rounded-xl p-6 mb-8 transition-colors duration-300`}>
              ...
              <div className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-[#000000] focus:border-transparent transition-colors font-outfit ${
                        isDark 
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    rows={5}
                    className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-[#000000] focus:border-transparent transition-colors font-outfit resize-none ${
                      isDark 
                        ? 'border-[rgba(251,191,36,0.2)] bg-[#000000] text-[#feffff] placeholder-[#ccc]/50' 
                        : 'border-gray-300 bg-white text-gray-900 placeholder-gray-500'
                    }`}
                ...
                <div className={`${isDark ? 'bg-[#000000] border-[rgba(251,191,36,0.2)]' : 'bg-gray-50 border-gray-200'} rounded-xl p-6 border transition-colors duration-300`}>
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-[#fbbf24] to-[#f59e0b] text-[#111] font-outfit font-semibold py-4 px-8 rounded-xl hover:shadow-lg hover:shadow-[#000000]/25 transform hover:scale-[1.02] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-3 text-lg"
                >
                  {isSubmitting ? (
                    <>
          ...
          <div className="space-y-6">
            ...
            <div className={`${isDark ? 'bg-[#0e1311] border-[rgba(251,191,36,0.2)]' : 'bg-white border-gray-200 shadow-lg'} rounded-2xl p-6 border transition-colors duration-300`}>
              ...
              <div className="text-center mb-8">
                <div className="relative inline-block">
                  <div className="w-20 h-20 bg-gradient-to-br from-[#fbbf24] to-[#f59e0b] rounded-full flex items-center justify-center shadow-lg mb-4">
                    <span className="text-[#111] font-outfit font-bold text-2xl">
                      {contactData?.agentName?.[0] || 'G'}
                    </span>
                  </div>
                  <div className="absolute -bottom-2 -right-2 w-6 h-6 bg-[#000000] rounded-full border-4 border-white flex items-center justify-center">
                ...
                <p className="text-sm text-[#000000] font-outfit font-semibold mt-1">● Available Now</p>
              </div>
              ...
              <div className="space-y-4 mb-8">
                <div className={`flex items-center gap-4 p-3 rounded-xl transition-colors duration-300 ${
                  ...
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    isDark ? 'bg-[rgba(251,191,36,0.2)]' : 'bg-emerald-100'
                  }`}>
                ...
                <div className={`flex items-center gap-4 p-3 rounded-xl transition-colors duration-300 ${
                  ...
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    isDark ? 'bg-[rgba(251,191,36,0.2)]' : 'bg-green-100'
                  }`}>
                ...
                <div className={`flex items-center gap-4 p-3 rounded-xl transition-colors duration-300 ${
                  ...
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    isDark ? 'bg-[rgba(251,191,36,0.2)]' : 'bg-purple-100'
                  }`}>
                ...
                <div className={`flex items-center gap-4 p-3 rounded-xl transition-colors duration-300 ${
                  ...
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                    isDark ? 'bg-[rgba(251,191,36,0.2)]' : 'bg-red-100'
                  }`}>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className={`${isDark ? 'bg-[rgba(251,191,36,0.1)]' : 'bg-emerald-50'} rounded-xl p-4 text-center transition-colors duration-300`}>
                  <div className={`text-xl font-outfit font-bold ${isDark ? 'text-[#000000]' : 'text-emerald-700'}`}>200+</div>
                  <div className={`text-sm font-outfit ${isDark ? 'text-[#ccc]' : 'text-emerald-600'}`}>Properties Sold</div>
                </div>
                <div className={`${isDark ? 'bg-[rgba(251,191,36,0.1)]' : 'bg-emerald-50'} rounded-xl p-4 text-center transition-colors duration-300`}>
                  <div className={`text-xl font-outfit font-bold ${isDark ? 'text-[#000000]' : 'text-emerald-700'}`}>4.8★</div>
            ...
            {/* Why Choose Us */}
            <div className={`${isDark ? 'bg-[#0e1311] border-[rgba(251,191,36,0.2)]' : 'bg-gradient-to-br from-emerald-50 via-purple-50 to-emerald-50 border-emerald-200'} rounded-2xl p-6 border transition-colors duration-300`}>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-[#fbbf24] to-[#f59e0b] rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div className={`mt-8 p-4 rounded-xl border transition-colors duration-300 ${
                isDark 
                  ? 'bg-[#000000] border-[rgba(251,191,36,0.2)]' 
                  : 'bg-white/60 border-white/40'
              }`}>
                <p className={`text-center text-sm font-outfit font-medium ${
                  isDark ? 'text-[#ccc]' : 'text-gray-700'
                }`}>
                  <Clock className="w-4 h-4 inline-block mr-2 text-[#000000]" />
