...
const OverviewSection = ({ stats, chartData, chartLabels }) => {
  ...
  const handleRefresh = async () => {
    ...
    // Data stays the same until a real analytics endpoint is available
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <select
            ...
            className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-emerald-500 dark:bg-gray-700 dark:text-white text-sm"
          >
