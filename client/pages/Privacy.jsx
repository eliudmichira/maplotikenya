...
const Privacy = ({ embedded = false }) => {
  ...
  return (
    <section className={`${embedded ? 'p-0 bg-transparent' : `pt-40 pb-20 min-h-screen ${isDark ? 'bg-[#000000]' : 'bg-white'}`}`}>
      <div className={`max-w-3xl mx-auto ${embedded ? '' : 'px-6'}`}>
        ...
        <div className={`${isDark ? 'text-white/70' : 'text-gray-700'} space-y-6`}>
          <p>
            At MaplotiKenya, we take your privacy seriously. This policy describes how we collect, use, and protect your information when you use our mobile application and web platform.
          </p>

          <h2 className={`text-xl font-semibold mb-3 ${isDark ? 'text-white' : 'text-gray-900'}`}>1. Information We Collect</h2>
          <div className="space-y-4">
            <div>
              <h3 className="font-bold mb-1 flex items-center gap-2"><Lock className="w-4 h-4 text-[#000000]" /> Account Information</h3>
            ...
            <div>
              <h3 className="font-bold mb-1 flex items-center gap-2"><MapPin className="w-4 h-4 text-[#000000]" /> Location Data</h3>
            ...
            <div>
              <h3 className="font-bold mb-1 flex items-center gap-2"><Eye className="w-4 h-4 text-[#000000]" /> Usage Data</h3>
          ...
          <p className="flex items-center gap-2">
            ...
            <a href="mailto:support@maplotikenya.com" className="text-[#000000] hover:underline font-bold">support@maplotikenya.com</a>
          </p>
        </div>
      </div>
    </section>
