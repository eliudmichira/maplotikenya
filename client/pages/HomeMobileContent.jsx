...
// Pure Mobile App Home Content Component for Bumi House (without navigation)
const HomeMobileContent = () => {
  ...
  // Debug logging
  console.log('Featured data from API:', featuredData);
  console.log('Featured properties array:', featuredProperties);
  console.log('Is loading:', featuredLoading);
  console.log('Has error:', featuredError);
  ...
  const getPropertyImage = (property) => {
    ...
    return 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&h=300&q=80';
  };
