...
const MobilePropertyCard = ({ property, onFavoriteToggle, isFavorite }) => {
  ...
  return (
    <div className={`group bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden transition-all duration-300 cursor-pointer hover:shadow-xl lg:hidden ${
