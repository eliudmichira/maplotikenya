...
function ModernLogin() {
  ...
  const { signIn, signInWithGoogleAuth, isVerifiedAgent } = auth || {};
             ...
             <form className="space-y-6" onSubmit={handleSubmit}>
               ...
               <div className="flex items-center justify-between">
                 <label className="flex items-center gap-3 cursor-pointer">
                   <input 
                     type="checkbox" 
                     className={`w-5 h-5 border-2 rounded focus:ring-2 transition-all duration-700 ease-out ${
                       isDark
                 ...
                 <button 
                   ...
                   className={`text-sm font-medium tracking-wide transition-colors duration-700 ease-out disabled:opacity-50 ${
